  ...
  const services = [
    {
      ...
      items: [
        { name: "Маникюр", price: "от 1500 ₽" },
        { name: "Наращивание ногтей", price: "от 3000 ₽" },
        { name: "Укрепление ногтей", price: "от 2000 ₽" },
        { name: "Педикюр", price: "от 2500 ₽" }
      ]
    },
    {
      category: "Брови и ресницы",
      items: [
        { name: "Покраска бровей", price: "от 800 ₽" },
        { name: "Ламинирование бровей", price: "от 2500 ₽" },
        { name: "Ламинирование ресниц", price: "от 2800 ₽" },
        { name: "Наращивание ресниц", price: "от 3500 ₽" }
      ]
    },
    {
      category: "Перманентный макияж",
      items: [
        { name: "Татуаж бровей", price: "от 8000 ₽" },
        { name: "Татуаж губ", price: "от 10000 ₽" },
        { name: "Перманентный макияж век", price: "от 7000 ₽" }
      ]
    },
    {
      category: "Эпиляция и уход",
      items: [
        { name: "Депиляция (зона на выбор)", price: "от 500 ₽" },
        { name: "Чистка лица", price: "от 3500 ₽" },
        { name: "Уход за лицом", price: "от 2500 ₽" },
        { name: "Биоревитализация", price: "от 8000 ₽" }
      ]
    },
    {
      category: "Массаж и коррекция фигуры",
      items: [
        { name: "LPG массаж", price: "от 2500 ₽" },
        { name: "Лимфодренажный массаж", price: "от 3000 ₽" },
        { name: "Ручной массаж", price: "от 2000 ₽" },
        { name: "Прессотерапия", price: "от 2000 ₽" }
      ]
    }
  ];
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="h-[400px] bg-gray-200 rounded-lg overflow-hidden">
              <iframe
                src="https://yandex.ru/map-widget/v1/?ll=30.281612%2C59.996175&z=17&l=map&pt=30.281612,59.996175,pm2rdm"
                width="100%"
                height="100%"
                frameBorder="0"
                className="grayscale"
