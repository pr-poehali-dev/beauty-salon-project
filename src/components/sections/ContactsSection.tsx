...
const ContactsSection = () => {
  return (
    <>
      ...
      <section id="контакты" className="py-20 px-4 bg-black text-white">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <p className="text-accent text-sm tracking-widest mb-4">КОНТАКТЫ</p>
            <h2 className="text-5xl font-light text-white">Где нас найти</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-light mb-2 text-white">Режим работы</h3>
